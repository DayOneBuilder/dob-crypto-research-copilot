        ---
        name: dob-crypto-research-copilot
        description: Installable crypto research workflow bundle for token due diligence, wallet checks, and yield scans.
        ---

        Use this skill when the user wants a structured crypto research workflow for token due diligence, wallet review, yield comparison, or a reusable research setup.
